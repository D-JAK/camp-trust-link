...
const en: Dict = {
  ...
  "state.predesignated": "Pre-designated site",
  "state.predesignatedNote": "This building is on the government's pre-designated monsoon camp list. Nobody has reported it as open yet — do not travel here without calling the local authorities first.",
  "status.active": "Open",
...
const ml: Dict = {
  ...
  "state.predesignated": "മുൻകൂട്ടി നിശ്ചയിച്ച കേന്ദ്രം",
